...
public class climbingSequenceUp extends SequentialCommandGroup {
    ...
    public climbingSequenceUp(Climber climber) {
        ...
        addCommands(new ParallelDeadlineGroup(new WaitCommand(5), new InstantCommand(()-> m_climber.setServoIn())), new RaiseClimberBasic(()-> .08, climber).until(m_climber :: internalEncoderPastThreshold), new WaitCommand(.4), new RaiseClimberBasic(()-> .085, climber)
