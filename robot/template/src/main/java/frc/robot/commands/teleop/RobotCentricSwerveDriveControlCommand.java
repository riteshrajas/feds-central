...
public class RobotCentricSwerveDriveControlCommand extends CommandBase {
    ...
    public RobotCentricSwerveDriveControlCommand(DriveSubsystem drive, DoubleSupplier forward, DoubleSupplier strafe,
