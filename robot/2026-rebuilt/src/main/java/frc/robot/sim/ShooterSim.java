...
public class ShooterSim {
     ...
     *
     * @param gamePieceManager       manages piece lifecycle (intake counter and
     *                               spawning)
     * @param fuelConfig             game piece config for launched balls
     * @param robotPoseSupplier      supplies the current robot 2D pose (for launch
     *                               direction)
     * @param hoodAngleSupplier      supplies the current hood angle in radians (0 =
     *                               horizontal)
     * @param launchVelocitySupplier supplies the launch speed in m/s
     * @param shootingSupplier       returns true when the shooter is actively
     *                               firing
     * @param robotVxSupplier        supplies the robot's world-frame X velocity
     *                               (m/s)
     * @param robotVySupplier        supplies the robot's world-frame Y velocity
     *                               (m/s)
     */
