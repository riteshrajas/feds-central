...
public class RebuiltSimManager {
    ...
    public RebuiltSimManager(CommandSwerveDrivetrain drivetrain, Shooter shooter, Intake intake) {
        ...
        physicsWorld.setTimeMultiplier(RobotMap.Constants.Sim.TIME_MULTIPLIER);
    ...
    public void periodic() {
        ...
        double simulatedDt = DT * RobotMap.Constants.Sim.TIME_MULTIPLIER;
        chassis.setVelocity(worldVx, worldVy, robotSpeeds.omegaRadiansPerSecond, simulatedDt);
