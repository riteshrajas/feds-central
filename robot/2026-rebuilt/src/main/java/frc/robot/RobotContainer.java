...
public class RobotContainer {
  ...
  // Shooter wired to live distance → looks up hood angle + velocity from
  // profiler-derived maps
  private final Shooter shooter = new Shooter(() -> drivetrain.getDistanceToHub().in(Meters));
