...
<GenericHero 
  ...
  height="sm"
  description='Your guide to success with Team 201: The FEDS!'
...
<GenericStats
  ...
  stats={[
    { value: 26, label: "Years of Excellence 🏆 — Over two decades of building bots and legacies.", suffix: "+" },
    { value: 16, label: "Blue Banners 🚩 — When your closet runs out of space for victory.", suffix: "+" },
    { value: 28, label: "Robots Built 🤖 — Each with more zip ties and caffeine than the last.", suffix: "+" },
    { value: 1000, label: "Students Mentored 👥 — Mentoring tomorrow’s engineers, today.", suffix: "+" }
  ]}
/>
...
<GenericTimeline
  ...
  items={[
    {
      title: 'Preseason Training & Outreach',
      date: 'Summer - Fall',
      description: 'Students participate in software/hardware training, host outreach events, run fundraisers, and bond through team-building activities.',
      icon: '🛠️',
      tags: ['Training', 'Outreach', 'Team Spirit']
    },
    {
      title: 'Kickoff & Game Reveal',
      date: 'January',
      description: 'FIRST unveils the new game challenge. The team begins brainstorming, strategizing, and planning how to conquer the year’s engineering puzzle.',
      icon: '📣',
    ...
    },
    {
      ...
      description: 'Six(ish) weeks of chaos, coding, CADing, and caffeine. Subteams bring the robot to life while working against the clock.',
      icon: '⚙️',
      tags: ['Engineering', 'Teamwork']
    },
    {
      title: 'Competition Season',
      date: 'Late February - April',
      description: 'Team 201 competes in Michigan District Events, showing off strategy, innovation, and sportsmanship in fierce alliances.',
      icon: '🏟️',
    ...
    },
    {
      ...
      date: 'Year-Round',
      description: 'Students gain technical mastery, leadership, business experience, and lifelong memories. It’s more than just robots—it’s transformation.',
      icon: '🌟',
      tags: ['Growth', 'Leadership', 'Experience']
    }
  ]}
/>
