...
### Conclusion
And that's the Elevator subsystem code! Check it out in full on our [github page](https://github.com/feds201/feds-central/blob/main/robot/2025-reefscape/src/main/java/frc/robot/subsystems/lift/Lift.java).