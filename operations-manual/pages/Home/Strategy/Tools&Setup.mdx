...
<Cards>
  <Card icon={<FaTabletAlt />} title="Mk3: First Digital Implementation" href='https://www.thebluealliance.com/event/2023michs'>
    - Android Studio
    - Python QR
    - Tableau
  ...
  <Card icon={<MdAutoGraph />} title="Mk4: Wayne State Refinement" href='https://www.thebluealliance.com/event/2023micmp'>
    Enhanced QR scanner with data relay improvements
  </Card>

  <Card icon={<FaExclamationTriangle />} title="Mk5: Troy Challenge" href='https://www.thebluealliance.com/event/2023michs'>
    Critical QR scanner failure highlighted backup importance
  </Card>
  
  <Card icon={<FaTrophy />} title="Mk5.5: FIM States Success" href='https://www.thebluealliance.com/event/2023mifim'>
