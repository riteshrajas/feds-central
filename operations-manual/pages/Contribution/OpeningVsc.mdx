...
Now, that you have installed VS Code, you will need to configure it to work with Git. This will allow you to make changes to the Operations Manual and submit pull requests.
...
These extensions will help you work with the Operations Manual more efficiently.
