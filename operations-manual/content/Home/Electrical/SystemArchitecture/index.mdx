...
<Tabs items={['PDH Channel Layout', 'Fuse Configuration', 'Power Budget']}>
  ...
  <Tabs.Tab>
    ...
    **Peak Power Scenarios:**
    - **Drivetrain (8 × Kraken X60)**: ~800W peak
    - **Elevator System (2 × Kraken X60)**: ~200W peak  
    - **Climb System (2 × Kraken X60)**: ~200W peak
    - **Carriage System (2 × Kraken X60)**: ~200W peak
...
<GenericGrid 
  ...
  items={[
    ...
    },
    {
      ...
      description: "Proper 120Ω termination resistors at both ends of each CAN bus prevent signal reflections",
      icon: "🔚",
      color: "green",
