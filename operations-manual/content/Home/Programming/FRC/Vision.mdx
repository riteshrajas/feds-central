...
<Tabs items={['Limelight OS', 'Photon OS']}>
    <Tabs.Tab>
        ...
        ### Libraries
        <br />
        <Cards.Card icon={<CiBookmarkPlus />} title="Limelight Library" target={'_blank'} href="https://raw.githubusercontent.com/LimelightVision/limelightlib-wpijava/main/LimelightHelpers.java" />
    ...
    <Tabs.Tab>
        ...
        ### Libraries
        <br />
        <Cards.Card icon={<CiBookmarkPlus />} title="Photon Library" target={'_blank'} href="https://maven.photonvision.org/repository/internal/org/photonvision/photonlib-json/1.0/photonlib-json-1.0.json" />

        ### PhotonVision Documentation
        <br />
        <Cards.Card icon={<CiBookmarkPlus />} title="PhotonVision Documentation" target={'_blank'} href="https://docs.photonvision.org/" />
    </Tabs.Tab>
</Tabs>
