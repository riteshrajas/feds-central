...
<Callout type={"info"} emoji={"💡"}>A typical IR break beam sensor is made of 2 parts: The **Transmitter** and the **Reciever**. The **Transmitter** does not have to be coded, as it only needs to be powered by the robot. On the other hand, the **Reciever** does need to be coded, as it is here.</Callout>
